    ...
    public class LoginController : ControllerBase
    {
        ...
        public IActionResult UserLogin(Login login)
        {
            ...
            if (users != null)
            {
                ...
                //model = new LoggedUserModel() { Id = farmer.farmerId, EmailID = farmer.farmerEmail, Token = token, Role = farmer.Role };
        ...
        public IActionResult TeamMembersLogin(Login login)
        {
            ...
            if (teammembers != null)
            {
                ...
                //model = new LoggedUserModel() { Id = supplier.supplierId, EmailID = supplier.supplierEmail, Token = token, Role = supplier.Role };
